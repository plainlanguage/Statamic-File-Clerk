...
$(function () {
	...
	var s3upload = {
		...
		bindUIActions: function() {
			...
			// Choose existing file
			$('body').on( 'dblclick doubletap', '.is-directory', this.loadExisting );

			// Breadcrumb
			$('body').on( 'click tap', '.breadcrumb a', this.loadExisting );

			// Highlight Row
			$('body').on( 'click tap', '.view-list td', this.highlightRow );
